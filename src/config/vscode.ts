...
export const vscodeGroups: VSCodeGroup[] = [
  {
    ...
    settings: [
      ...
      { key: "Letter Spacing", value: s("editor.letterSpacing") },
      { key: "Font Ligatures", value: s("editor.fontLigatures") },
      { key: "Cursor Blinking", value: s("editor.cursorBlinking") },
      { key: "Smooth Caret", value: s("editor.cursorSmoothCaretAnimation") },
      { key: "Line Numbers", value: s("editor.lineNumbers") },
      { key: "Word Wrap", value: s("editor.wordWrap") },
      { key: "Minimap", value: s("editor.minimap.enabled") },
      { key: "Format on Save", value: s("editor.formatOnSave") },
      { key: "Format on Paste", value: s("editor.formatOnPaste") },
      { key: "Mouse Wheel Zoom", value: s("editor.mouseWheelZoom") },
      { key: "Render Whitespace", value: s("editor.renderWhitespace") },
      { key: "Auto Save", value: s("files.autoSave") },
  ...
  },
  {
    ...
    settings: [
      ...
      { key: "Mouse Wheel Zoom", value: s("terminal.integrated.mouseWheelZoom") },
